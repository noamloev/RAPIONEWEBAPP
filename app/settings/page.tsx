  ...
  return (
    <button
      ...
      className={`w-full rounded-[24px] border px-4 py-4 text-left transition ${
        active
          ? "border-[var(--border-strong)] bg-[linear-gradient(180deg,#ffffff_0%,#faf1ff_100%)] shadow-[0_16px_30px_rgba(192,38,211,0.14)]"
          ...
          >
            <div className="flex flex-wrap gap-3">
              <button
                ...
                className="rounded-2xl bg-[var(--primary-strong)] px-5 py-3 text-sm font-semibold text-white shadow-[0_14px_30px_rgba(192,38,211,0.24)] transition hover:-translate-y-0.5 disabled:opacity-60"
              >
        ...
        >
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <button
              ...
              className="self-end rounded-2xl bg-[var(--primary-strong)] px-5 py-3 text-sm font-semibold text-white shadow-[0_14px_30px_rgba(192,38,211,0.24)] transition hover:-translate-y-0.5 disabled:opacity-60"
            >
